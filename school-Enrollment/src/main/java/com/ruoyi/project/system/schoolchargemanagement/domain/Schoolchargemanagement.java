package com.ruoyi.project.system.schoolchargemanagement.domain;
...
/**
 * 收费管理对象 schoolchargemanagement
 * 
 * @author ruoyi
 * @date 2019-10-21
 */
public class Schoolchargemanagement extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("payService", getPayService())
            .append("detailsOfCharges", getDetailsOfCharges())
