package com.ruoyi.project.system.schoolenrollmentmanagement.domain;
...
/**
 * 招生管理对象 schoolenrollmentmanagement
 * 
 * @author ruoyi
 * @date 2019-10-21
 */
public class Schoolenrollmentmanagement extends BaseEntity
{
    ...
    /** 计划人数 */
    @Excel(name = "计划人数")
    private String plannedPopulation;
    ...
    public void setPlannedPopulation(String plannedPopulation) 
    {
        this.plannedPopulation = plannedPopulation;
    }

    public String getPlannedPopulation() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("id", getId())
            .append("enrollmentBatch", getEnrollmentBatch())
            .append("plannedPopulation", getPlannedPopulation())
