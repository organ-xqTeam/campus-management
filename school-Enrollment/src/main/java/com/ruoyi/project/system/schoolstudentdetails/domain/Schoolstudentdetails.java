package com.ruoyi.project.system.schoolstudentdetails.domain;
...
/**
 * 学生明细对象 schoolstudentdetails
 * 
 * @author ruoyi
 * @date 2019-10-21
 */
public class Schoolstudentdetails extends BaseEntity
{
    ...
    /** 收费明细id */
    @Excel(name = "收费明细id")
    private String chargingDetailsId;
    ...
    public void setChargingDetailsId(String chargingDetailsId) 
    {
        this.chargingDetailsId = chargingDetailsId;
    }

    public String getChargingDetailsId() 
    {
        return chargingDetailsId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("id", getId())
            .append("chargingDetailsId", getChargingDetailsId())
