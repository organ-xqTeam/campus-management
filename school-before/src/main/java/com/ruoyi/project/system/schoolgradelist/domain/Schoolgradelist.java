package com.ruoyi.project.system.schoolgradelist.domain;
...
/**
 * 年级管理对象 schoolgradelist
 * 
 * @author ruoyi
 * @date 2019-11-27
 */
public class Schoolgradelist extends BaseEntity
{
    ...
    public String getGradecharge2() {
		return gradecharge2;
	}

	public void setGradecharge2(String gradecharge2) {
		this.gradecharge2 = gradecharge2;
	}
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("gradecharge", getGradecharge())
