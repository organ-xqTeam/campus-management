package com.ruoyi.project.system.classcurriculum.domain;
 ...
 * @date 2019-11-19
 */
public class Classcurriculum extends BaseEntity
{
    ...
    /** 排课管理id */
    @Excel(name = "排课管理id")
    private String classschedulingmanagementId;
    ...
    public void setClassschedulingmanagementId(String classschedulingmanagementId) 
    {
        this.classschedulingmanagementId = classschedulingmanagementId;
    }

    public String getClassschedulingmanagementId() 
    {
        return classschedulingmanagementId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("classschedulingmanagementId", getClassschedulingmanagementId())
