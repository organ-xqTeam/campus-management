package com.ruoyi.project.system.classschedulingmanagement.domain;
...
/**
 * 排课管理对象 classschedulingmanagement
 * 
 * @author ruoyi
 * @date 2019-11-19
 */
public class Classschedulingmanagement extends BaseEntity
{
