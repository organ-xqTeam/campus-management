package com.ruoyi.project.system.examSubjectOptionOption.domain;
...
/**
 * 选择题选项表 exam_subject_option_option
 * 
 * @author ruoyi
 * @date 2019-08-13
 */
public class ExamSubjectOptionOption extends BaseEntity
{
