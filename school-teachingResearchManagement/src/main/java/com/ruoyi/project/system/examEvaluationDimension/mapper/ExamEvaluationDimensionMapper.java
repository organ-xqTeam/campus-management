package com.ruoyi.project.system.examEvaluationDimension.mapper;
 ...
 * @date 2019-08-16
 */
public interface ExamEvaluationDimensionMapper 
{
	/**
     * 查询选择题选项信息
     * 
     ...
     * @return 结果
     */
	public int deleteExamEvaluationDimensionById(String id);
