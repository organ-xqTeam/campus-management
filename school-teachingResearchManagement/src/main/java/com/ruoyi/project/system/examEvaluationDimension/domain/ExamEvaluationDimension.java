package com.ruoyi.project.system.examEvaluationDimension.domain;
...
/**
 * 选择题选项表 exam_evaluation_dimension
 * 
 * @author ruoyi
 * @date 2019-08-16
 */
public class ExamEvaluationDimension extends BaseEntity
{
