package com.ruoyi.project.system.examAccountSequence.mapper;
 ...
 * @date 2019-10-24
 */
public interface ExamAccountSequenceMapper 
{
	/**
     * 查询科目测评维度顺序显示信息
     * 
     ...
     * @return 结果
     */
	public int deleteExamAccountSequenceById(String id);
